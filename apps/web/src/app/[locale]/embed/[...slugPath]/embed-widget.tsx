...
function EmbedHeader({
  ...
  return (
    <div
      className="flex shrink-0 items-center gap-3 border-b border-[hsl(var(--border-default))] px-4 py-3"
...
function EmbedFooter() {
  return (
    <div className="shrink-0 border-t border-[hsl(var(--border-default))] px-4 py-2 text-center">
      <a
